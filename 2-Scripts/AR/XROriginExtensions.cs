...
public static class XROriginExtensions
{
    ...
    public static void ShiftOriginTo(this XROrigin origin, Vector3 position, Quaternion rotation)
    {
        ShiftOriginTo(origin, position);
        ShiftOriginTo(origin, rotation);
    }
    ...
    public static void ShiftOriginTo(this XROrigin origin, Vector3 position)
    {
        var originTransform = origin.transform;
    ...
    public static void ShiftOriginTo(this XROrigin origin, Quaternion rotation)
    {
        origin.transform.rotation = Quaternion.Inverse(rotation) * Quaternion.identity;
    }
}